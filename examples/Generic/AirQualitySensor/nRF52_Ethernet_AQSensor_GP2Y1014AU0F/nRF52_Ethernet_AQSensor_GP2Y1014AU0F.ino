...
#define SHARP_VO_PIN            A0            // Select an analog input pin to read dust density according to your board
...
void setup() 
{
  ...
  Serial.println("\nStarting nRF52_Ethernet_AQSensor_GP2Y1014AU0F on " + String(BOARD_NAME));
