/****************************************************************************************************************************
  SAMD_Ethernet_Speaker.ino
  For For Arduino SAMD21, Adafruit SAMD21, SAMD51 boards, running W5x00 or ENC28J60 Ethernet shield
...
bool onAdjustBands(const String &deviceId, const String &bands, int &levelDelta)
{
  ...
  Serial.println("Device " + deviceId + " bands \"" + bands + "\" adjusted about " + String(levelDelta) + " to " + String(
...
void setup()
{
  ...
  Serial.println("\nStarting SAMD_Ethernet_Speaker on " + String(BOARD_NAME));
