/****************************************************************************************************************************
  nRF52_Ethernet_TemperatureSensor.ino
...
void setup() 
{
  ...
  Serial.println("\nStarting SAMD_Ethernet_TemperatureSensor on " + String(BOARD_TYPE));
#else
  Serial.println("\nStarting SAMD_Ethernet_TemperatureSensor on unknown SAMD board");
#endif
