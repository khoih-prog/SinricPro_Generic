...
#define THERMOSTAT_ID     "YOUR-DEVICE-ID"      // Should look like "5dc1564130xxxxxxxxxxxxxx"
...
void setup() 
{
  ...
  Serial.println("\nStarting nRF52_Ethernet_Thermostat on " + String(BOARD_TYPE));
#else
  Serial.println("\nStarting nRF52_Ethernet_Thermostat on unknown nRF52 board");
#endif
