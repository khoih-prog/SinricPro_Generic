...
{
  Serial.print("Device " + deviceId + String(state ? " turned on" : " turn off") + " (via SinricPro)" );
...
void setup()
{
  ...
  Serial.println("\nStarting nRF52_Ethernet_Switch on " + String(BOARD_TYPE));
#else
  Serial.println("\nStarting nRF52_Ethernet_Switch on unknown nRF52 board");
#endif  
