/****************************************************************************************************************************
  nRF52_Ethernet_MultiSwitch_beginner.ino
...
void setup() 
{
  ...
  Serial.println("\nStarting nRF52_Ethernet_MultiSwitch_beginner on " + String(BOARD_TYPE));
#else
  Serial.println("\nStarting nRF52_Ethernet_MultiSwitch_beginner on unknown board");
#endif  
