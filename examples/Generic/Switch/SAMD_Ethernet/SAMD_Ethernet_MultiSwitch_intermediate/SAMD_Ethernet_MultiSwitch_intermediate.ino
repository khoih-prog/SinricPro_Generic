/****************************************************************************************************************************
  SAMD_Ethernet_MultiSwitch_intermediate.ino
...
void setup()
{
  ...
  Serial.println("\nStarting SAMD_Ethernet_MultiSwitch_intermediate on " + String(BOARD_TYPE));
#else
  Serial.println("\nStarting SAMD_Ethernet_MultiSwitch_intermediate on unknown board");
#endif  
