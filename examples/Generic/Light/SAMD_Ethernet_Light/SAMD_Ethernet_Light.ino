...
void setupColorTemperatureIndex()
{
  ...
  for (int i = 0; i < max_color_temperatures; i++)
  {
    ...
    Serial.println("colorTemperatureIndex[" + String(colorTemperatureArray[i]) + "] = " + String(
...
bool onAdjustBrightness(const String &deviceId, int brightnessDelta)
{
  ...
  Serial.println("Device " + deviceId + " brightness level changed about " + String(brightnessDelta) + " to " + String(
...
void setup()
{
  ...
  Serial.println("\nStarting SAMD_Ethernet_Light on " + String(BOARD_NAME));
