...
void AES_Crypto::encrypt(uint32_t *data)
{
...
*/
void AES_Crypto::decrypt(uint32_t *data)
{
  uint32_t tmp[4];
...
AES_Crypto::AES_Crypto(const uint8_t *key, const uint8_t *iv, AES_MODE mode, CIPHER_MODE cipherMode)
{
...
int AES_Crypto::getSize()
{
  return _size;
}

void AES_Crypto::setSize(int size)
{
  _size = size;
}

int AES_Crypto::calcSizeAndPad(int in_size)
{
...
bool AES_Crypto::checkPad(uint8_t* in, int lsize)
{
  if (in[lsize - 1] <= 0x0f)
  {
...
void AES_Crypto::processNoPad(const uint8_t *in, uint8_t *out, int length)
{
...
void AES_Crypto::process(const uint8_t *in, uint8_t *out, int length)
{
  if (_cipherMode == CIPHER_ENCRYPT)
  {
...
void AES_Crypto::encryptCBC(const uint8_t *in, uint8_t *out, int length)
{
  int i;
...
void AES_Crypto::decryptCBC(const uint8_t *in, uint8_t *out, int length)
{
  int i;
