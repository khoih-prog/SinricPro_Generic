...
15. [`WiFiNINA_Generic library v1.7.1+`](https://github.com/khoih-prog/WiFiNINA_Generic). To install. check [![arduino-library-badge](https://www.ardu-badge.com/badge/WiFiNINA_Generic.svg?)](https://www.ardu-badge.com/WiFiNINA_Generic) if using WiFiNINA for boards such as Nano 33 IoT, nRF52, Teensy, etc.
...
Each item is a directory containing many examples designed for different kinds of boards (SAMD, nRF52, STM32, SAM DUE, etc.) and shields/modules (Ethernet/WiFiNINA)
 ...
 4. [ContactSensor](examples/Generic/ContactSensor)
 5. [DimSwitch](examples/Generic/DimSwitch)
 6. [doorbell](examples/Generic/doorbell)
 7. [Fan](examples/Generic/Fan)
 8. [GarageDoor](examples/Generic/GarageDoor)
 9. [Light](examples/Generic/Light)
10. [Lock](examples/Generic/Lock)
11. [MotionSensor](examples/Generic/MotionSensor)
12. [PowerSensor](examples/Generic/PowerSensor)
13. [Speaker](examples/Generic/Speaker)
14. [Generic_Ethernet](examples/Generic/Switch/Generic_Ethernet)
15. [Generic_WiFiNINA](examples/Generic/Switch/Generic_WiFiNINA)
16. [nRF52_Ethernet](examples/Generic/Switch/nRF52_Ethernet)
17. [nRF52_WiFiNINA](examples/Generic/Switch/nRF52_WiFiNINA)
18. [SAMD_Ethernet](examples/Generic/Switch/SAMD_Ethernet)
19. [SAMD_WiFiNINA](examples/Generic/Switch/SAMD_WiFiNINA)
